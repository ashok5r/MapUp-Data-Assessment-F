...
def generate_car_matrix(df)->pd.DataFrame:
    ...
    df = pd.read_csv("D:\MapUp-Data-Assessment-F\datasets\dataset-1.csv")
...
dataset_path = "D:\MapUp-Data-Assessment-F\datasets\dataset-1.csv"
...
result_df = generate_car_matrix("D:\MapUp-Data-Assessment-F\datasets\dataset-1.csv")
...
def time_check(df)->pd.Series:
    ...
    """
    # Write your logic here
    df = pd.read_csv("D:\MapUp-Data-Assessment-F\datasets\dataset-2.csv")
    ...
    boolean_series = full_day_check & days_check

    return boolean_series

dataset_path = "D:\MapUp-Data-Assessment-F\datasets\dataset-2.csv"
boolean_series = time_check(dataset_path)
